...
public class GestionDessertsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        b_supprimer = findViewById(R.id.b_supprimerGD);
        b_ajouter = findViewById(R.id.b_ajouterGD);
        b_modifier = findViewById(R.id.b_modifierGD);
        t_ajouter = findViewById(R.id.t_estNouveauGD);
        t_modifier = findViewById(R.id.t_modifierGD);
        l_checkbox = findViewById(R.id.l_checkboxGD);
        s_modifier = findViewById(R.id.s_modifierGD);
        ...
        b_modifier.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(!t_modifier.getText().toString().isEmpty() && s_modifier.getSelectedItem()!=null){
                    ...
                    Modele.lesDesserts.set(itemSelectedPosition, t_modifier.getText().toString());
    ...
    public void afficherChk() {
        ...
        for(int i=0;i<Modele.lesDesserts.size();i++) {
            ...
            unchk.setText(Modele.lesDesserts.get(i));
            lstCheck.add(unchk);
    ...
    public void affSpiderPlats() {
        ...
        for (int i = 0; i < Modele.lesDesserts.size(); i++) {
            contenuPlats.add(Modele.lesDesserts.get(i));
        }
